...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/rpc_client_mock.go -package mocks code.zetaprotocol.io/vega/core/nodewallets/eth/clef Client
