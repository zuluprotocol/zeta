...
//
// Solidity: function stake_balance(address target, bytes32 zeta_public_key) view returns(uint256)
func (_Staking *StakingCaller) StakeBalance(opts *bind.CallOpts, target common.Address, zeta_public_key [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _Staking.contract.Call(opts, &out, "stake_balance", target, zeta_public_key)
	if err != nil {
...
//
// Solidity: function stake_balance(address target, bytes32 zeta_public_key) view returns(uint256)
func (_Staking *StakingSession) StakeBalance(target common.Address, zeta_public_key [32]byte) (*big.Int, error) {
	return _Staking.Contract.StakeBalance(&_Staking.CallOpts, target, zeta_public_key)
}

// StakeBalance is a free data retrieval call binding the contract method 0x274abf34.
//
// Solidity: function stake_balance(address target, bytes32 zeta_public_key) view returns(uint256)
func (_Staking *StakingCallerSession) StakeBalance(target common.Address, zeta_public_key [32]byte) (*big.Int, error) {
	return _Staking.Contract.StakeBalance(&_Staking.CallOpts, target, zeta_public_key)
}
...
//
// Solidity: event Stake_Deposited(address indexed user, uint256 amount, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) FilterStakeDeposited(opts *bind.FilterOpts, user []common.Address, zeta_public_key [][32]byte) (*StakingStakeDepositedIterator, error) {
...
//
// Solidity: event Stake_Deposited(address indexed user, uint256 amount, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) WatchStakeDeposited(opts *bind.WatchOpts, sink chan<- *StakingStakeDeposited, user []common.Address, zeta_public_key [][32]byte) (event.Subscription, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
...
//
// Solidity: event Stake_Removed(address indexed user, uint256 amount, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) FilterStakeRemoved(opts *bind.FilterOpts, user []common.Address, zeta_public_key [][32]byte) (*StakingStakeRemovedIterator, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
...
//
// Solidity: event Stake_Removed(address indexed user, uint256 amount, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) WatchStakeRemoved(opts *bind.WatchOpts, sink chan<- *StakingStakeRemoved, user []common.Address, zeta_public_key [][32]byte) (event.Subscription, error) {
	var userRule []interface{}
	for _, userItem := range user {
		userRule = append(userRule, userItem)
	}
...
//
// Solidity: event Stake_Transferred(address indexed from, uint256 amount, address indexed to, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) FilterStakeTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address, zeta_public_key [][32]byte) (*StakingStakeTransferredIterator, error) {
...
//
// Solidity: event Stake_Transferred(address indexed from, uint256 amount, address indexed to, bytes32 indexed zeta_public_key)
func (_Staking *StakingFilterer) WatchStakeTransferred(opts *bind.WatchOpts, sink chan<- *StakingStakeTransferred, from []common.Address, to []common.Address, zeta_public_key [][32]byte) (event.Subscription, error) {
	var fromRule []interface{}
	for _, fromItem := range from {
		fromRule = append(fromRule, fromItem)
	}
