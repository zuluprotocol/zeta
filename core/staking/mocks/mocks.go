...
// Source: zuluprotocol/zeta/core/staking (interfaces: EvtForwarder,EthereumClientConfirmations,EthereumEventSource,TimeService,EthConfirmations,EthOnChainVerifier,Witness)
