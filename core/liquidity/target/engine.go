...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/open_interest_calculator_mock.go -package mocks code.zetaprotocol.io/vega/core/liquidity/target OpenInterestCalculator
