...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/auction_state_mock.go -package mocks zuluprotocol/zeta/core/monitor/price AuctionState
...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/price_range_provider_mock.go -package mocks zuluprotocol/zeta/core/monitor/price RangeProvider
type RangeProvider interface {
	PriceRange(price, yearFraction, probability num.Decimal) (num.Decimal, num.Decimal)
}

//go:generate go run github.com/golang/mock/mockgen -destination mocks/state_var_mock.go -package mocks zuluprotocol/zeta/core/monitor/price StateVarEngine
