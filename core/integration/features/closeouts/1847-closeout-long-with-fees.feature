Feature: Long close-out test (see ln 293 of system-tests/grpc/trading/tradesTests.py & https://github.com/zetaprotocol/scenario-runner/tree/develop/scenarios/QA/issues/86)
