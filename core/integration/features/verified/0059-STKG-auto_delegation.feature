...
Scenario: A party dissociates ZETA token leading to undelegation proportionally to their current delegation (0059-STKG-012, 0059-STKG-018)
    Description: Once a party dissociates ZETA tokens their delegation is adjusted automatically to reflect that in the same propotion as the delegation with respect to the amount withdrawn
...
Scenario: A party qualifies to auto delegation by delegating all of their associated tokens however by manually undelegation they exit auto delegation mode (0059-STKG-013, STKG-0014, 0059-STKG-021)
    Description: Once a party dissociates ZETA tokens their delegation is adjusted automatically to reflect that in the same proportion as the delegation with respect to the amount withdrawn
