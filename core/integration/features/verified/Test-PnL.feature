Feature: check if the realised PnL and unreaslied PnL is calculated according to spec in glossaries: https://github.com/zetaprotocol/specs/blob/master/glossaries/trading-and-protocol-glossary.md
