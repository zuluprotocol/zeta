Feature: Test settlement at expiry time from internal oracle
  ...
  Background:
    ...
    And the oracle spec for trading termination filtering data from "zetaprotocol.builtin" named "ethDec20Oracle":
      | property                       | type           | binding             | condition                      | value                |
      | zetaprotocol.builtin.timestamp | TYPE_TIMESTAMP | trading termination | OPERATOR_GREATER_THAN_OR_EQUAL | 2019-12-31T23:59:59Z |
