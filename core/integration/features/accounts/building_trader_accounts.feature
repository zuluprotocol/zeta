Feature: Test party accounts
  ...
  Scenario: a party deposit collateral onto Zeta. The general account for this asset increase
    Given the parties deposit on asset's general account the following amount:
      | party  | asset | amount |
      | party1 | ETH   | 100    |
      | party1 | VUSD  | 100    |
  ...
  Scenario: a party withdraw collateral onto Zeta. The general account for this asset decrease
    Given the parties deposit on asset's general account the following amount:
      | party  | asset | amount |
      | party1 | ETH   | 100    |
      | party1 | VUSD  | 100    |
