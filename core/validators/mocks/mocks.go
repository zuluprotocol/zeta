...
// Source: code.zetaprotocol.io/vega/core/validators (interfaces: NodeWallets,TimeService,Commander,ValidatorTopology,Wallet,ValidatorPerformance,Notary,Signatures,MultiSigTopology)
...
import (
	...
	txn "code.zetaprotocol.io/vega/core/txn"
	validators "code.zetaprotocol.io/vega/core/validators"
	crypto "code.zetaprotocol.io/vega/libs/crypto"
	v1 "code.zetaprotocol.io/vega/protos/vega/commands/v1"
	v10 "code.zetaprotocol.io/vega/protos/vega/snapshot/v1"
...
// GetZeta indicates an expected call of GetVega.
func (mr *MockNodeWalletsMockRecorder) GetZeta() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZeta", reflect.TypeOf((*MockNodeWallets)(nil).GetVega))
}
...
func (mr *MockValidatorTopologyMockRecorder) IsValidatorZetaPubKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorZetaPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).IsValidatorVegaPubKey), arg0)
}
...
// SelfZetaPubKey indicates an expected call of SelfVegaPubKey.
func (mr *MockValidatorTopologyMockRecorder) SelfZetaPubKey() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelfZetaPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).SelfVegaPubKey))
}
