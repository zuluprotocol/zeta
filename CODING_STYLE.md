...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/foo_buffer_mock.go -package mocks code.zetaprotocol.io/zeta/foo FooBuffer
...
```go
//go:generate go run github.com/golang/mock/mockgen -destination mocks/some_dependency_mock.go -package mocks code.zetaprotocol.io/zeta/pkg SomeDependency
