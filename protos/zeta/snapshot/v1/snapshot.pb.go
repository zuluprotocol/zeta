...
import (
	...
	v11 "zuluprotocol/zeta/protos/zeta/checkpoint/v1"
	v1 "zuluprotocol/zeta/protos/zeta/data/v1"
	v12 "zuluprotocol/zeta/protos/zeta/events/v1"
...
var file_zeta_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*LiquidityPriceProbabilityPair)(nil),        // 8: zeta.snapshot.v1.LiquidityPriceProbabilityPair
	...
	(*AssetAction)(nil),                          // 24: zeta.snapshot.v1.AssetAction
	(*BankingWithdrawals)(nil),                   // 25: zeta.snapshot.v1.BankingWithdrawals
	(*BankingDeposits)(nil),                      // 26: zeta.snapshot.v1.BankingDeposits
	(*BankingSeen)(nil),                          // 27: zeta.snapshot.v1.BankingSeen
	(*BankingAssetActions)(nil),                  // 28: zeta.snapshot.v1.BankingAssetActions
	(*BankingRecurringTransfers)(nil),            // 29: zeta.snapshot.v1.BankingRecurringTransfers
	(*BankingScheduledTransfers)(nil),            // 30: zeta.snapshot.v1.BankingScheduledTransfers
	(*BankingBridgeState)(nil),                   // 31: zeta.snapshot.v1.BankingBridgeState
	(*Checkpoint)(nil),                           // 32: zeta.snapshot.v1.Checkpoint
	(*DelegationLastReconciliationTime)(nil),     // 33: zeta.snapshot.v1.DelegationLastReconciliationTime
	(*DelegationActive)(nil),                     // 34: zeta.snapshot.v1.DelegationActive
	(*DelegationPending)(nil),                    // 35: zeta.snapshot.v1.DelegationPending
	(*DelegationAuto)(nil),                       // 36: zeta.snapshot.v1.DelegationAuto
	(*ProposalData)(nil),                         // 37: zeta.snapshot.v1.ProposalData
	(*GovernanceEnacted)(nil),                    // 38: zeta.snapshot.v1.GovernanceEnacted
	(*GovernanceActive)(nil),                     // 39: zeta.snapshot.v1.GovernanceActive
	(*GovernanceNode)(nil),                       // 40: zeta.snapshot.v1.GovernanceNode
	(*StakingAccount)(nil),                       // 41: zeta.snapshot.v1.StakingAccount
	(*StakingAccounts)(nil),                      // 42: zeta.snapshot.v1.StakingAccounts
	(*MatchingBook)(nil),                         // 43: zeta.snapshot.v1.MatchingBook
	(*NetParams)(nil),                            // 44: zeta.snapshot.v1.NetParams
	(*DecimalMap)(nil),                           // 45: zeta.snapshot.v1.DecimalMap
	(*TimePrice)(nil),                            // 46: zeta.snapshot.v1.TimePrice
	(*PriceVolume)(nil),                          // 47: zeta.snapshot.v1.PriceVolume
	(*PriceRange)(nil),                           // 48: zeta.snapshot.v1.PriceRange
	(*PriceBound)(nil),                           // 49: zeta.snapshot.v1.PriceBound
	(*PriceRangeCache)(nil),                      // 50: zeta.snapshot.v1.PriceRangeCache
	(*CurrentPrice)(nil),                         // 51: zeta.snapshot.v1.CurrentPrice
	(*PastPrice)(nil),                            // 52: zeta.snapshot.v1.PastPrice
	(*PriceMonitor)(nil),                         // 53: zeta.snapshot.v1.PriceMonitor
	(*AuctionState)(nil),                         // 54: zeta.snapshot.v1.AuctionState
	(*EquityShareLP)(nil),                        // 55: zeta.snapshot.v1.EquityShareLP
	(*EquityShare)(nil),                          // 56: zeta.snapshot.v1.EquityShare
	(*FeeSplitter)(nil),                          // 57: zeta.snapshot.v1.FeeSplitter
	(*Market)(nil),                               // 58: zeta.snapshot.v1.Market
	(*PeggedOrders)(nil),                         // 59: zeta.snapshot.v1.PeggedOrders
	(*ExecutionMarkets)(nil),                     // 60: zeta.snapshot.v1.ExecutionMarkets
	(*Position)(nil),                             // 61: zeta.snapshot.v1.Position
	(*MarketPositions)(nil),                      // 62: zeta.snapshot.v1.MarketPositions
	(*SettlementState)(nil),                      // 63: zeta.snapshot.v1.SettlementState
	(*LastSettledPosition)(nil),                  // 64: zeta.snapshot.v1.LastSettledPosition
	(*SettlementTrade)(nil),                      // 65: zeta.snapshot.v1.SettlementTrade
	(*AppState)(nil),                             // 66: zeta.snapshot.v1.AppState
	(*EpochState)(nil),                           // 67: zeta.snapshot.v1.EpochState
	(*RewardsPendingPayouts)(nil),                // 68: zeta.snapshot.v1.RewardsPendingPayouts
	(*ScheduledRewardsPayout)(nil),               // 69: zeta.snapshot.v1.ScheduledRewardsPayout
	(*RewardsPayout)(nil),                        // 70: zeta.snapshot.v1.RewardsPayout
	(*RewardsPartyAmount)(nil),                   // 71: zeta.snapshot.v1.RewardsPartyAmount
	(*LimitState)(nil),                           // 72: zeta.snapshot.v1.LimitState
	(*VoteSpamPolicy)(nil),                       // 73: zeta.snapshot.v1.VoteSpamPolicy
	(*PartyProposalVoteCount)(nil),               // 74: zeta.snapshot.v1.PartyProposalVoteCount
	(*PartyTokenBalance)(nil),                    // 75: zeta.snapshot.v1.PartyTokenBalance
	(*BlockRejectStats)(nil),                     // 76: zeta.snapshot.v1.BlockRejectStats
	(*SpamPartyTransactionCount)(nil),            // 77: zeta.snapshot.v1.SpamPartyTransactionCount
	(*SimpleSpamPolicy)(nil),                     // 78: zeta.snapshot.v1.SimpleSpamPolicy
	(*NotarySigs)(nil),                           // 79: zeta.snapshot.v1.NotarySigs
	(*Notary)(nil),                               // 80: zeta.snapshot.v1.Notary
	(*StakeVerifierDeposited)(nil),               // 81: zeta.snapshot.v1.StakeVerifierDeposited
	(*StakeVerifierRemoved)(nil),                 // 82: zeta.snapshot.v1.StakeVerifierRemoved
	(*StakeVerifierPending)(nil),                 // 83: zeta.snapshot.v1.StakeVerifierPending
	(*PendingKeyRotation)(nil),                   // 84: zeta.snapshot.v1.PendingKeyRotation
	(*PendingEthereumKeyRotation)(nil),           // 85: zeta.snapshot.v1.PendingEthereumKeyRotation
	(*Topology)(nil),                             // 86: zeta.snapshot.v1.Topology
	(*ToplogySignatures)(nil),                    // 87: zeta.snapshot.v1.ToplogySignatures
	(*PendingERC20MultisigControlSignature)(nil), // 88: zeta.snapshot.v1.PendingERC20MultisigControlSignature
