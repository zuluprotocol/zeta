...
type SubmitTransactionRequest struct {
	...
	// A bundle of signed payload and signature, to form a transaction that will be submitted to the Zeta blockchain
...
type CheckTransactionRequest struct {
	...
	// A bundle of signed payload and signature, to form a transaction that would be submitted to the Zeta blockchain
	Tx *v1.Transaction `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}
...
type SubmitRawTransactionRequest struct {
	...
	// A bundle of signed payload and signature marshalled into a byte array, to form a transaction that will be submitted to the Zeta blockchain
...
type CheckRawTransactionRequest struct {
	...
	// A bundle of signed payload and signature marshalled into a byte array, to form a transaction that would be submitted to the Zeta blockchain
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}
...
// A a request for statistics about the Zeta network
...
type Statistics struct {
	...
	// The version hash of the Zeta node software
	...
	// Unique identifier for the underlying Zeta blockchain
