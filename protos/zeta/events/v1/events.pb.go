...
type ERC20MultiSigSignerAdded struct {
	...
	// The zeta node ID of the node to be added
...
type ERC20MultiSigSignerRemoved struct {
	...
	// The zeta node ID of the node which is to be removed
	ValidatorId string `protobuf:"bytes,2,opt,name=validator_id,json=validatorId,proto3" json:"validator_id,omitempty"`
	// the time at which this happened
	Timestamp int64 `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
...
type StakeLinking struct {
	...
	// The time at which the zeta network finalized the state of the event
...
// A time update event contains the latest time update from Zeta blockchain and indicates the start of a new block
...
// A market ticket event contains the time value for when a particular market was last processed on Zeta
...
// A key rotation events contains information about Zeta key rotation
...
// A bus event is a container for event bus events emitted by Zeta
...
type BusEvent_EpochEvent struct {
	// Epoch update events - See [Epoch](#zeta.Epoch)
...
type BusEvent_Market struct {
	// Market tick events - See [MarketEvent](#zeta.MarketEvent)
...
var file_zeta_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_zeta_events_v1_events_proto_goTypes = []interface{}{
	...
	(*MarketTick)(nil),                          // 34: zeta.events.v1.MarketTick
	(*AuctionEvent)(nil),                        // 35: zeta.events.v1.AuctionEvent
	(*ValidatorUpdate)(nil),                     // 36: zeta.events.v1.ValidatorUpdate
	(*ValidatorRankingEvent)(nil),               // 37: zeta.events.v1.ValidatorRankingEvent
	(*KeyRotation)(nil),                         // 38: zeta.events.v1.KeyRotation
	(*EthereumKeyRotation)(nil),                 // 39: zeta.events.v1.EthereumKeyRotation
	(*ProtocolUpgradeEvent)(nil),                // 40: zeta.events.v1.ProtocolUpgradeEvent
	(*StateVar)(nil),                            // 41: zeta.events.v1.StateVar
	(*BeginBlock)(nil),                          // 42: zeta.events.v1.BeginBlock
	(*EndBlock)(nil),                            // 43: zeta.events.v1.EndBlock
	(*ProtocolUpgradeStarted)(nil),              // 44: zeta.events.v1.ProtocolUpgradeStarted
	(*ProtocolUpgradeDataNodeReady)(nil),        // 45: zeta.events.v1.ProtocolUpgradeDataNodeReady
	(*CoreSnapshotData)(nil),                    // 46: zeta.events.v1.CoreSnapshotData
	(*BusEvent)(nil),                            // 47: zeta.events.v1.BusEvent
	...
	(*v1.ProposalSubmission)(nil),               // 56: zeta.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                   // 57: zeta.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),     // 58: zeta.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),               // 59: zeta.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),               // 60: zeta.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),             // 61: zeta.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil),   // 62: zeta.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),      // 63: zeta.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                         // 64: zeta.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                   // 65: zeta.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                     // 66: zeta.commands.v1.AnnounceNode
	(*v1.OracleDataSubmission)(nil),             // 67: zeta.commands.v1.OracleDataSubmission
	(*v1.ProtocolUpgradeProposal)(nil),          // 68: zeta.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                  // 69: zeta.commands.v1.IssueSignatures
...
func file_zeta_events_v1_events_proto_init() {
	...
	file_zeta_events_v1_events_proto_msgTypes[41].OneofWrappers = []interface{}{
