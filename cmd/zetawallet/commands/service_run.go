...
import (
	...
	walletapi "zuluprotocol/zeta/wallet/api"
	"zuluprotocol/zeta/wallet/api/interactor"
	netStoreV1 "zuluprotocol/zeta/wallet/network/store/v1"
	...
	"zuluprotocol/zeta/wallet/version"
...
func RunService(w io.Writer, rf *RootFlags, f *RunServiceFlags) error {
	...
	walletStore, err := wallets.InitialiseStoreFromPaths(zetaPaths)
	if err != nil {
