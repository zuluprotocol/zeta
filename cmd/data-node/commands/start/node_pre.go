...
func (l *NodeCommand) initialiseNetworkHistory(preLog *logging.Logger, connConfig sqlstore.ConnectionConfig) error {
	...
	l.snapshotService, err = snapshot.NewSnapshotService(snapshotServiceLog, l.conf.NetworkHistory.Snapshot,
		networkHistoryPool, l.zetaPaths.StatePathFor(paths.DataNodeNetworkHistorySnapshotCopyFrom),
	...
	l.networkHistoryService, err = networkhistory.New(l.ctx, networkHistoryServiceLog, l.conf.NetworkHistory, l.zetaPaths.StatePathFor(paths.DataNodeNetworkHistoryHome),
		networkHistoryPool,
		l.conf.SQLStore.ConnectionConfig, l.conf.ChainID, l.snapshotService, l.conf.API.Port, l.zetaPaths.StatePathFor(paths.DataNodeNetworkHistorySnapshotCopyFrom),
		l.zetaPaths.StatePathFor(paths.DataNodeNetworkHistorySnapshotCopyTo))
