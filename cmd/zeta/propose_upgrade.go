...
type ProposeUpgradeCmd struct {
	...
	ZetaReleaseTag     string `short:"v" long:"zeta-release-tag" required:"true" description:"A valid vega core release tag for the upgrade proposal"`
...
func (opts *ProposeUpgradeCmd) Execute(_ []string) error {
	...
	cmd := commandspb.ProtocolUpgradeProposal{
		ZetaReleaseTag:     opts.VegaReleaseTag,
