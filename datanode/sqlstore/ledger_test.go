...
func TestLedger(t *testing.T) {
	...
	/*
		...
		accounts[10] => asset2, parties[5], markets[5], zeta.AccountType_ACCOUNT_TYPE_INSURANCE
		accounts[11] => asset2, parties[5], markets[6], zeta.AccountType_ACCOUNT_TYPE_INSURANCE
		...
		accounts[20] => asset3, parties[10], markets[10], zeta.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
		accounts[21] => asset3, parties[10], markets[11], zeta.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
	*/
	for i := 0; i < 17; i++ {
	...
	/*
		...
		accounts[10]->accounts[11] => asset2, parties[5], markets[5-6], zeta.AccountType_ACCOUNT_TYPE_INSURANCE

		accounts[5]->accounts[10] => asset2, parties[2-5], markets[3-5], zeta.AccountType_ACCOUNT_TYPE_INSURANCE

		accounts[5]->accounts[11] => asset2, parties[2-5], markets[3-6], zeta.AccountType_ACCOUNT_TYPE_INSURANCE
		...
		accounts[21]->accounts[15] => asset3, parties[10-7], markets[9-8], zeta.AccountType_ACCOUNT_TYPE_FEES_LIQUIDITY
	*/
