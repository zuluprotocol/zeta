...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/networkhistory_service_mock.go -package mocks code.zetaprotocol.io/vega/datanode/networkhistory NetworkHistory
