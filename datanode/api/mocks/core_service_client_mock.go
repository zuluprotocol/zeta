...
// Source: code.zetaprotocol.io/vega/datanode/api (interfaces: CoreServiceClient)
...
func (m *MockCoreServiceClient) GetZetaTime(arg0 context.Context, arg1 *v1.GetVegaTimeRequest, arg2 ...grpc.CallOption) (*v1.GetVegaTimeResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockCoreServiceClientMockRecorder) GetZetaTime(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZetaTime", reflect.TypeOf((*MockCoreServiceClient)(nil).GetVegaTime), varargs...)
}
