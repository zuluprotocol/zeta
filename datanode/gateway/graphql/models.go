...
import (
	...
	"zuluprotocol/zeta/protos/data-node/api/v2"
	"zuluprotocol/zeta/protos/zeta"
	"zuluprotocol/zeta/protos/zeta/data/v1"
)
...
type LedgerEntry struct {
	...
	FromAccountID *zeta.AccountDetails `json:"fromAccountId"`
	// Account to which the balance was transferred
	ToAccountID *zeta.AccountDetails `json:"toAccountId"`
	// The amount transferred
	Amount string `json:"amount"`
	// Type of ledger entry
	Type zeta.TransferType `json:"type"`
