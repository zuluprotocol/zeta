...
import (
	...
	vgversion "code.zetaprotocol.io/vega/libs/version"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/store_mock.go -package mocks code.zetaprotocol.io/vega/wallet/version NetworkStore
