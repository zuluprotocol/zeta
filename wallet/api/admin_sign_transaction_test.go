...
import (
	...
	"code.zetaprotocol.io/vega/wallet/api/mocks"
	walletnode "code.zetaprotocol.io/vega/wallet/api/node"
	nodemocks "code.zetaprotocol.io/vega/wallet/api/node/mocks"
...
func testAdminSigningTransactionWithMalformedTransactionFails(t *testing.T) {
	...
	// then
	assertInvalidParams(t, errorDetails, errors.New("the transaction is not a valid Zeta command: unknown field \"bob\" in zeta.wallet.v1.SubmitTransactionRequest"))
	assert.Empty(t, result)
}
