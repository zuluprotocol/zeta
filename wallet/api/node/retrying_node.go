...
import (
	...
	"code.zetaprotocol.io/vega/wallet/api/node/adapters"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/node_mock.go -package mocks code.zetaprotocol.io/vega/wallet/api/node GRPCAdapter
